    ...
    <div class="col-6 mx-auto">
      ...
      <form action="" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" name="title" class="form-control" id="title" placeholder="Fiil in the title" required>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" name="country" class="form-control" id="country" placeholder="Production Place" required>
        </div>
        <div class="form-group">
